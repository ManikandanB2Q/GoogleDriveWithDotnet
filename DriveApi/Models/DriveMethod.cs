...
namespace DriveApi.Models
{
    public class GoogleDriveFilesRepository
    {
        ...
        public static Google.Apis.Drive.v3.DriveService GetService()
        {
            ...
            var CSPath = System.Web.Hosting.HostingEnvironment.MapPath("~/GoogleDriveFiles/");

            using (var stream = new FileStream(Path.Combine(CSPath, "client_secret_943451650510-a120pm4im1n738avos1ha846lb8kavja.apps.googleusercontent.com.json"), FileMode.Open, FileAccess.Read))  //client_secret
            {
